(* Ulm's Modula-2 System: Makefile Generator
   ...
   ----------------------------------------------------------------------------
   $Id: Macros.d,v 0.1 1997/02/24 08:36:06 borchert Exp $
   ----------------------------------------------------------------------------
   $Log: Macros.d,v $
   Revision 0.1  1997/02/24  08:36:06  borchert
   Initial revision

   ----------------------------------------------------------------------------
*)

DEFINITION MODULE Macros; (* 3/87 *)

   PROCEDURE EnterMacro(name, val: ARRAY OF CHAR);

   PROCEDURE WriteMacro(name, default: ARRAY OF CHAR);
